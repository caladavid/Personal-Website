        ...
        <header>
            <nav className="relative flex justify-between w-11/12 2xl:w-3/4 m-auto transition-all border-b-[1px] text-black/80 border-black/80 overflow-hidden">
                <div className="text-base lg:text-lg p-9 uppercase">
                    ...
                    href='/'><Logo width={50} className='hover:fill-white transition-all'/></a>
                </div>
                ...
                <AnimatePresence >
                    {sticky && <motion.button className={`stickyNav flex justify-end mr-[7%] lg:mr-[5%] 2xl:mr-[3%] z-20 rounded-full`} onClick={handleToggleNavbar}
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
                        exit={{ scale: 0 }}
                ...
                <ul className="hidden md:w-auto md:h-auto md:mb-0 md:bg-transparent md:flex md:flex-row md:justify-between gap-5 lg:gap-20  text-base lg:text-lg p-9 uppercase">
                    ...
                    <li className="">
                        <a href='/docs/DavidCalaResume.pdf' download className="hover:bg-[#c94d20] text-white bg-orange py-4 p-8 rounded-md transition-all">Resume</a>
                    </li> 
                </ul>
            </nav>
        </header>
