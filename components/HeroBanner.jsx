        ...
        <section>
            <Wrapper>
                <div className="relative h-full flex flex-col justify-evenly sm:justify-center">       
                    <h1 className="break-words font-semibold break-keep uppercase text-center sm:text-left text-4xl min-[490px]:text-7xl md:text-8xl lg:text-[9rem] min-[1850px]:text-[12rem] py-20 md:mt-10 min-[500px]:py-40 lg:pb-40 ">Web<br /> Developer</h1>
